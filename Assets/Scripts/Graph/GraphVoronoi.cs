...
public class GraphVoronoi {
	...
	public Vector2 terrainSize{ set { p_terrainSize = value; } }

	private float p_terrainHeight;
	public float terrainHeight{ set { p_terrainHeight = value; } }
...
//	}
	...
	private void createRivers() {
		...
		int k=0;
		for (int i = 0; i <p_corners.Count/200; i++) {
